...
- **Four Insurance Variant:** 4대보험 조회에서는 스테이션 제목 아래 12px 보조 텍스트로 출처·조회 지역·자료 범위·건강보험 미제공과 국민연금 주소·사업자번호 한계를 함께 알린다.
- **Basis Line:** 4대보험 조회는 실시간 호출이 아니라 국민연금 월별 스냅샷과 고용·산재 연말 스냅샷을 읽는다. 자료가 언제 것인지 국민연금 자료생성년월·갱신일과 고용·산재 원본 기준일·변환일로 적어, 두 자료의 시점 차이를 판단할 수 있게 한다. 국민연금 사업자등록번호가 앞 6자리까지만, 주소가 건물번호 없이 도로명까지만 제공되고 고용·산재 사업장관리번호별 행은 보존되며, 연결되지 않는 행도 빠지지 않는다는 점을 명시한다.
