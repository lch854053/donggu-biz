...
export function licenseStatusKind(item) {
  const code = clean(item.SALS_STTS_CD);
  if (code === LOCALDATA_STATUS_CODES.active) return "active";
  if (code === LOCALDATA_STATUS_CODES.suspended) return "suspended";
  if (code === LOCALDATA_STATUS_CODES.closed) return "closed";
...
export function isActiveLicense(item) {
  return licenseStatusKind(item) === "active";
}

export function isClosedLicense(item) {
  return licenseStatusKind(item) === "closed";
}

export function isSuspendedLicense(item) {
  return licenseStatusKind(item) === "suspended";
}
