const EXCLUDED_VWORLD_ZONE_NUMBERS = new Set(["9730", "9731", "9732", "9733"]);
const EXCLUDED_VWORLD_ZONE_NAMES = new Set(["금남로4가역_1", "금남로4가역_2", "금남로4가역_3", "금남로4가역_4"]);
...
export function mergeZoneFeatures(...payloads) {
  ...
  const numbers = features.map((feature) => String(feature?.properties?.no || ""));
